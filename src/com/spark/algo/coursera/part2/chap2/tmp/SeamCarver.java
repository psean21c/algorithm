package com.spark.algo.coursera.part2.chap2.tmp;
...
public class SeamCarver {
    ...
    /**
     * The energy of pixel (x, y) is (delta)x^2(x, y) + (delta)y^2(x, y)
     * 
     * @param x
    ...
    /**
     * Square of the gradient (delta)^2(x, y) = R(x, y)^2 + G(x, y)^2 + B(x, y)^2
     * 
     * @param a
     * @param b
