...
//    	useConfig(args[0]);
    ...
    /***
     * 
     * need to configure the argument in the Run/Debug Configuration
     * .\resource\java\algo\coursera\part1\chap1\input2.txt
     */
    ...
    /***
     * 
     * folder = .\resource\java\algo\coursera\part1\chap1\
	 * filename = input2.txt
     * file = folder + filename
     */
	static void useConsole() {
		Scanner scanner = new Scanner(System.in);
		String folder = ".\\resource\\java\\algo\\coursera\\part1\\chap1\\";
